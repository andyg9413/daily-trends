...
import { mapArticleToFeed } from '../scrapping/scrapper.transform';
...
const mockElpaisService = new ElpaisService({feedService: mockFeedService}) as jest.Mocked<ElpaisService>;
const mockElmundoService = new ElmundoService({feedService: mockFeedService}) as jest.Mocked<ElmundoService>;
...
describe('ScrapperService', () => {
    ...
    it('should get and save all feeds without limit', async () => {
        const mockElpaisArticles: IArticle[] = [
            { title: 'Elpais Title 1', body: 'Elpais Body 1', link: 'https://elpais.com/1.png', image: 'https://image.elpais.com/1.png' },
            { title: 'Elpais Title 2', body: 'Elpais Body 2', link: 'https://elpais.com/2.png', image: 'https://image.elpais.com/1.png' },
        ];
        const mockElmundoArticles: IArticle[] = [
            { title: 'Elmundo Title 1', body: 'Elmundo Body 1', link: 'https://elmundo.es/1.png', image: 'https://image.elmundo.es/1.png' },
            { title: 'Elmundo Title 2', body: 'Elmundo Body 2', link: 'https://elmundo.es/2.png', image: 'https://image.elmundo.es/2.png' },
        ];
